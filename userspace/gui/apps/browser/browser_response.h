...
enum browser_response_kind { BROWSER_RESPONSE_HTML, BROWSER_RESPONSE_IMAGE, BROWSER_RESPONSE_CSS, BROWSER_RESPONSE_SCRIPT };
uint32_t browser_response_script_max_age(const uint8_t *,uint32_t);
