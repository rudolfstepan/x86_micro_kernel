"""Read both actual images; unchanged kernels/protected programs, new JS runner."""
...
KERNELS={'qemu':'c5aa2d2b57103a376a27d2c075528cb86cd875c9d94d46aa5208997fcc3d098a',
         'vmware':'281503cfaed297ee320e0167120a7f139e28ff2dd0859e186ff4d138621e77ac'}
...
def main():
    ...
    try:
        ...
        for name,path in paths.items():
            ...
            if name in ('JSWORK.PRG','JSIPCTST.PRG','JS.PRG','JSRUNTST.PRG') and path+'=$(SYSTEM_PROGRAM_DIR)/'+name not in makefile:
            ...
            aliases[name]=alias
        for required in (*PINNED,'JS.PRG','JSRUNTST.PRG','JSWORK.PRG','JSIPCTST.PRG','BROWSER.PRG','HTMLWORK.PRG','DESKTOP.PRG'):
    ...
    print('JS_RUNNER_ARTIFACTS '+('PASS' if report['passed'] else 'FAIL: '+report['error']))
