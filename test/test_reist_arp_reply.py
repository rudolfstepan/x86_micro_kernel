...
class ReistArpReplyTests(unittest.TestCase):
    ...
    def test_local_arp_requests_are_exclusively_service_owned(self):
        ...
        self.assertNotIn("REIST_NETWORK ARP_REQUEST_QUEUED", handoff)
        self.assertNotIn("REIST_NETWORK ARP_REPLY_MEDIATED", supervisor)
    ...
    def test_runner_injects_a_real_bounded_arp_frame(self):
        ...
        self.assertIn("def receive_arp_reply(", runner)
        self.assertIn("frame[14:22] == b\"\\x00\\x01\\x08\\x00\\x06\\x04\\x00\\x02\"", runner)
        self.assertNotIn("REIST_ARP_REPLY_MARKER", runner)
        self.assertNotIn("REIST_ARP_REQUEST_QUEUED_MARKER", runner)
