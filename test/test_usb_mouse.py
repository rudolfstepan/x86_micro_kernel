...
class UsbMouseTests(unittest.TestCase):
    ...
    def test_usbinfo_is_reachable_from_the_normal_userspace_shell(self):
        ...
        self.assertIn("X86OS_USB_DIAGNOSTICS_VERSION 4U", sdk_header)
        ...
        self.assertIn("sizeof(x86os_usb_diagnostics_t) == 180U", sdk)
        ...
        self.assertIn("sizeof(syscall_usb_diagnostics_t) == 180U", syscalls)
