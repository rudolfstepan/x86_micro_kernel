...
_Static_assert(sizeof(host_workspace)<=36U*1024U*1024U,"unchanged workspace ceiling");
_Static_assert(sizeof(host_workspace.input_bytes)>=BROWSER_CSS_WIRE_CAPACITY,"full scene receive");
_Static_assert(sizeof(host_workspace.input_bytes)>=BROWSER_IMAGE_INPUT_LIMIT+REIST_CURL_HEADER_CAPACITY,"full image receive");
_Static_assert(sizeof(host_workspace.input_bytes)>=BROWSER_RESOURCE_LIMIT,"full stylesheet receive");
