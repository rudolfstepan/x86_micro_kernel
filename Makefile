...
CONFIG_VARIANT := f$(FAULT_INJECTION)-m$(MEMORY_FAULT_INJECTION)-s$(STORAGE_FAULT_INJECTION)-io$(STORAGE_IO_FAULT_INJECTION)-a$(AHCI_FAULT_INJECTION)-$(AHCI_FAULT_MODE)-h$(HANDOVER_FAULT_INJECTION)-n$(HANDOVER_NODE_ID)-dl$(DHCP_LEASE_FAULT_INJECTION)-dr$(DHCP_RENEW_FAULT_INJECTION)-v$(VBE_RUNTIME_TEST)-dd$(DRIVER_DOMAIN_FAULT_INJECTION)-svs$(SVGA2D_SMP_LIFECYCLE_FAULT_INJECTION)-rd$(RUNTIME_DEGRADATION_FAULT_INJECTION)
